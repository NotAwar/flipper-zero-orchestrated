...
// Add containerization header
#ifdef CLI_CONTAINERIZATION_ENABLED
#include "cli_commands_containerization.h"
#endif
...
void cli_commands_init(Cli* cli) {
    ...
    cli_command_add_gpio(cli);

    // Add containerization commands when enabled
#ifdef CLI_CONTAINERIZATION_ENABLED
    cli_commands_containerization_init(cli);
#endif
}

void cli_commands_deinit(Cli* cli) {
    // Remove containerization commands when enabled
#ifdef CLI_CONTAINERIZATION_ENABLED
    cli_commands_containerization_deinit(cli);
#endif
}
